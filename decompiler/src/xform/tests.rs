    ...
    fn part_of_concat() {
        ...
        fn gen_prog(vp: VariantParams) -> mil::Program {
            ...
            p.push(
                ...
                Insn::Ancestral {
                    anc_name: ANC_A,
                    ll_type: mil::LLType::Bytes(vp.anc_a_sz as _),
                },
            );
            p.push(
                Reg(1),
                Insn::Ancestral {
                    anc_name: ANC_B,
                    ll_type: mil::LLType::Bytes(vp.anc_b_sz as _),
                },
            );
            p.push(
                Reg(2),
    ...
    fn part_of_part() {
        ...
        fn gen_prog(vp: VariantParams) -> mil::Program {
            ...
            p.push(
                ...
                Insn::Ancestral {
                    anc_name: ANC_A,
                    ll_type: mil::LLType::Bytes(vp.src_sz as _),
                },
            );
            p.push(
                Reg(1),
...
mod struct_ptr_member_access {
    use crate::{
        mil::{self, ArithOp, Control, Insn, LLType, Reg},
        ssa,
        ty::{self, TypeID},
        xform,
    };
